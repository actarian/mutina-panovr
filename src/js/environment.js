...
export const STATIC = NODE ? false : (window && (window.location.port === '41234' || window.location.host === 'actarian.github.io' || window.location.host === 'mutina-panovr.herokuapp.com'));
...
export class Environment {
	...
	get href() {
		if (window.location.host.indexOf('herokuapp') !== -1) {
			return 'https://raw.githubusercontent.com/actarian/mutina-panovr/master/docs/';
		} else {
			return BASE_HREF;
		}
	}
